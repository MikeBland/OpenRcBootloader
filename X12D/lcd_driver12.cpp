...
void lcd_init()
{
  RCC_APB1PeriphClockCmd(INTERRUPT_5MS_APB1Periph | TIMER_2MHz_APB1Periph, ENABLE ) ;
  RCC_AHB1PeriphClockCmd( PWR_RCC_AHB1Periph | LCD_RCC_AHB1Periph | KEYS_RCC_AHB1Periph_GPIO, ENABLE) ;
  RCC_APB2PeriphClockCmd( LCD_RCC_APB2Periph, ENABLE ) ;
	...
	RCC->AHB1ENR |= RCC_AHB1ENR_GPIOFEN | RCC_AHB1ENR_GPIOGEN | RCC_AHB1ENR_GPIOHEN | RCC_AHB1ENR_GPIOIEN | RCC_AHB1ENR_GPIOJEN | RCC_AHB1ENR_GPIOKEN ;
...
void lcd_clear()
{
	lcd_clearBackground() ;
	waitLcdClearDdone() ;	
	lcdDrawSolidFilledRectDMA( 0, STATUS_VERTICAL, 480, 22, LCD_STATUS_GREY ) ;
}
